<template>
  <div class="row no-gutters mt-3">
    ...
    <div class="col-lg ml-3">
      <div class="card border-primary d-none d-lg-block" v-bind:style="{height: height}">
        <div class="card-header gradient text-white p-2 h6">Prediction</div>
...
<script>
  import Dashboard from "./Predictor";
  import List from "./ImageList";

  export default {
    name: "cala-live",
    components: {
      "cala-dashboard": Dashboard,
      "cala-imagelist": List
    },
    data() {
      return {
